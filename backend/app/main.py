...
@app.get("/api/participants/", response_model=list[schemas.Participant])
...
@app.get("/api/participants/{participant_id}", response_model=schemas.Participant)
...
@app.get("/api/leads/{lead_id}/notes", response_model=List[schemas.Note])
...
@app.post("/api/addendums/", response_model=schemas.Addendum)
...
@app.get("/api/addendums/", response_model=list[schemas.Addendum])
...
@app.get("/api/addendums/{addendum_id}", response_model=schemas.Addendum)
...
@app.put("/api/addendums/{addendum_id}", response_model=schemas.Addendum)
...
@app.delete("/api/addendums/{addendum_id}")
